...
class Interceptor extends \Magento\Catalog\Pricing\Render\FinalPriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderAmountMinimal');
        if (!$pluginInfo) {
            return parent::renderAmountMinimal();
        } else {
            return $this->___callPlugins('renderAmountMinimal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasSpecialPrice');
        if (!$pluginInfo) {
            return parent::hasSpecialPrice();
        } else {
            return $this->___callPlugins('hasSpecialPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function showMinimalPrice()
    {
        ...
        if (!$pluginInfo) {
            return parent::showMinimalPrice();
        } else {
            return $this->___callPlugins('showMinimalPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaleableItem');
        if (!$pluginInfo) {
            return parent::getSaleableItem();
        } else {
            return $this->___callPlugins('getSaleableItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceId');
        if (!$pluginInfo) {
            return parent::getPriceId($defaultPrefix, $defaultSuffix);
        } else {
            return $this->___callPlugins('getPriceId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceType');
        if (!$pluginInfo) {
            return parent::getPriceType($priceCode);
        } else {
            return $this->___callPlugins('getPriceType', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function renderAmount(\Magento\Framework\Pricing\Amount\AmountInterface $amount, array $arguments = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderAmount');
        if (!$pluginInfo) {
            return parent::renderAmount($amount, $arguments);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRendererPool');
        if (!$pluginInfo) {
            return parent::getRendererPool();
        } else {
            return $this->___callPlugins('getRendererPool', func_get_args(), $pluginInfo);
        }
    }
