<?php
/**
 * Infobeans_SocialLogin extension
 *                     NOTICE OF LICENSE
 *
 ...
 *
 * @category  Infobeans
 * @package   Infobeans_SocialLogin
 * @copyright Copyright (c) 2016
 * @license   http://opensource.org/licenses/mit-license.php MIT License
 */
namespace Infobeans\SocialLogin\Setup;
...
class InstallSchema implements \Magento\Framework\Setup\InstallSchemaInterface
{
    ...
    public function install(\Magento\Framework\Setup\SchemaSetupInterface $setup, \Magento\Framework\Setup\ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('infobeans_social_customer')) {
            $table = $installer->getConnection()->newTable(
                $installer->getTable('infobeans_social_customer')
            )
                ->addColumn(
                ...
                ->addColumn(
                    ...
                    $installer->getFkName('infobeans_social_customer', 'customer_id', 'customer_entity', 'entity_id'),
                    'customer_id',
