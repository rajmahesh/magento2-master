<?php
namespace Infobeans\SocialLogin\Model;
...
class Social extends AbstractModel
{
	...
	public function __construct(
		...
		\Infobeans\SocialLogin\Helper\Social $apiHelper,
	...
	{
		$this->_init('Infobeans\SocialLogin\Model\ResourceModel\Social');
	}
	...
	public function getAuth($apiName)
	{
		...
		try {
			$auth = $this->objectManager->create('Infobeans\SocialLogin\Hybrid\Auth', ['config' => $config]);
	...
	{
		return $this->objectManager->create('Infobeans\SocialLogin\Hybrid\Endpoint');
	}
