<?php
namespace Infobeans\SocialLogin\Controller;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Store\Model\StoreManagerInterface;
use Infobeans\SocialLogin\Helper\Social as SocialHelper;
use Infobeans\SocialLogin\Model\Social;
use Magento\Customer\Model\Session;

/**
 * Class AbstractSocial
 * @package Infobeans\SocialLogin\Controller
 */
abstract class AbstractSocial extends Action
{
	...
	/**
	 * @type \Infobeans\SocialLogin\Controller\AbstractSocial|mixed
	 */
	protected $apiHelper;
	 ...
	 * @param \Infobeans\SocialLogin\Helper\Data $apiHelper
