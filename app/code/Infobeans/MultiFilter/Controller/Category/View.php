<?php
namespace Infobeans\MultiFilter\Controller\Category;
...
class View extends \Magento\Framework\App\Action\Action 
{
    ...
    public function aroundExecute(\Magento\Catalog\Controller\Category\View $subject, \Closure $proceed) {
        $moduleActivation = $this->_objectManager->get('Infobeans\MultiFilter\Helper\Data')->getConfig('multifilter/general/active');
