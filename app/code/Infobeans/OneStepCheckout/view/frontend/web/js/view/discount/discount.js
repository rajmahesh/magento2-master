...
define(
    [
        ...
        'Infobeans_OneStepCheckout/js/action/set-coupon-code',
        'Infobeans_OneStepCheckout/js/action/cancel-coupon',
        'Infobeans_OneStepCheckout/js/ib/components'
    ],
    function ($, ko, Component, quote, setCouponCodeAction, cancelCouponAction) {
        ...
        return Component.extend({
            defaults: {
                template: 'Infobeans_OneStepCheckout/payment/discount'
            },
