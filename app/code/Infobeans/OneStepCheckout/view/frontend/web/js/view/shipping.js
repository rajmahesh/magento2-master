define(
    [
        ...
        'Infobeans_OneStepCheckout/js/model/shipping-rates-validator',
        'Magento_Checkout/js/model/shipping-address/form-popup-state',
        'Infobeans_OneStepCheckout/js/model/shipping-service',
        ...
        'uiRegistry',
        'mage/translate',
        'Infobeans_OneStepCheckout/js/model/shipping-rate-service'
    ],
    function(
        $,
        _,
        ...
        return Component.extend({
            defaults: {
                template: 'Infobeans_OneStepCheckout/shipping'
            },
            ...
            initialize: function () {
                ...
                $('body').addClass('ib-onepage-checkout').addClass(window.checkoutConfig.onestepcheckoutLayout);
                if (quote.isVirtual()) {
                    $('body').addClass('ib-onepage-checkout').addClass('ib-osc-virtual');
                }
