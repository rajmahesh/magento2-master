 ...
 */
namespace Infobeans\OneStepCheckout\Model\Comment;
...
class CustomBlockConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $enabled = $this->scopeConfiguration
            ->getValue('infobeans_onestepcheckout/general/onepage_checkout_comments_enabled', ScopeInterface::SCOPE_STORE);
